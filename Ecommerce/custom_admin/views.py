...
#     # Prevent changes if order is already cancelled
...
#         else:
#             messages.error(request, "Order must be in 'Return Requested' status to accept.")
#         return redirect('custom_admin:order_management')
...
#         else:
#             messages.error(request, "Order must be in 'Return Requested' status to reject.")
#         return redirect('custom_admin:order_management')
