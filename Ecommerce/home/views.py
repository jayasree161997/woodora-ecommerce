...
#             else:
#                 return JsonResponse({"success": False, "error": "Return not allowed for this order status."})
...
#                 return JsonResponse({"success": False, "error": "This order has already been returned."})

#             # Allow returns only for specific statuses
#             allowed_statuses = ["Delivered", "Return Requested", "Return Accepted"]
...
#                 return JsonResponse({"success": True, "message": "Return processed, amount credited to wallet."})
#             else:
#                 return JsonResponse({"success": False, "error": f"Return not allowed for this order status: {order.status}"})
